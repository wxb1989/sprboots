...
import com.eds.cloud.bussiness.core.config.FeignMultipartSupportConfiguration;
...
@FeignClient(name = "eds-base", configuration = FeignMultipartSupportConfiguration.class,
